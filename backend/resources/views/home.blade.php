...
@section('head')
    ...
    <link rel="preload" as="image" href="/images/screenshot-1000.webp" imagesrcset="/images/screenshot-600.webp 600w, /images/screenshot-1000.webp 1000w, /images/screenshot.webp 2556w" imagesizes="(max-width: 660px) 600px, (max-width: 1060px) 1000px, 2556px" fetchpriority="high">
        ...
        <div class="screenshot-wrapper">
            <picture>
                <source
                    ...
                    sizes="(max-width: 660px) 600px, (max-width: 1060px) 1000px, 2556px">
