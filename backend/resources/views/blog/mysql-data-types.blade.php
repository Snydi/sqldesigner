...
@section('head')
    <meta name="description" content="A practical guide to MySQL data types: numeric, string, date/time, and JSON types — with advice on which to choose for each use case.">
    ...
    <meta property="og:description" content="A practical guide to MySQL data types: numeric, string, date/time, and JSON types — with advice on which to choose for each use case.">
    ...
    <style>
        ...
        .blog-post li { font-size: 0.9rem; color: #444; background-color: transparent; text-transform: none; line-height: 1.8; margin-bottom: 0.3rem; }
...
<article class="blog-post">
    ...
    <h2>Numeric Types</h2>
    <table>
        <tr><th>Type</th><th>Storage</th><th>Range (signed)</th><th>Use for</th></tr>
        <tr><td><code>TINYINT</code></td><td>1 byte</td><td>-128 to 127</td><td>Booleans, small status flags</td></tr>
        <tr><td><code>SMALLINT</code></td><td>2 bytes</td><td>-32,768 to 32,767</td><td>Small counters, age, year</td></tr>
        <tr><td><code>INT</code></td><td>4 bytes</td><td>-2.1B to 2.1B</td><td>General-purpose IDs and counts</td></tr>
        <tr><td><code>BIGINT</code></td><td>8 bytes</td><td>±9.2 quintillion</td><td>High-volume tables, snowflake IDs</td></tr>
        <tr><td><code>DECIMAL(p,s)</code></td><td>Variable</td><td>Exact</td><td>Money, measurements requiring precision</td></tr>
        <tr><td><code>FLOAT</code> / <code>DOUBLE</code></td><td>4 / 8 bytes</td><td>Approximate</td><td>Scientific values where small errors are acceptable</td></tr>
    </table>
    ...
    <h2>String Types</h2>
    <table>
        <tr><th>Type</th><th>Max size</th><th>Use for</th></tr>
        <tr><td><code>CHAR(n)</code></td><td>255 chars</td><td>Fixed-length strings: country codes, hashes, status enums</td></tr>
        <tr><td><code>VARCHAR(n)</code></td><td>65,535 bytes</td><td>Variable-length strings: names, emails, URLs, titles</td></tr>
        <tr><td><code>TEXT</code></td><td>65,535 bytes</td><td>Long content: descriptions, comments, HTML</td></tr>
        <tr><td><code>MEDIUMTEXT</code></td><td>16 MB</td><td>Large documents, article bodies</td></tr>
        <tr><td><code>LONGTEXT</code></td><td>4 GB</td><td>Very large content (logs, serialised data)</td></tr>
    </table>
    ...
    <table>
        <tr><th>Type</th><th>Range</th><th>Use for</th></tr>
        <tr><td><code>DATE</code></td><td>1000-01-01 to 9999-12-31</td><td>Dates without time: birthdays, deadlines</td></tr>
        <tr><td><code>DATETIME</code></td><td>1000-01-01 to 9999-12-31</td><td>Timestamps stored in application timezone</td></tr>
        <tr><td><code>TIMESTAMP</code></td><td>1970-01-01 to 2038-01-19</td><td>Audit timestamps stored in UTC, auto-converted on retrieval</td></tr>
        <tr><td><code>TIME</code></td><td>-838:59:59 to 838:59:59</td><td>Durations, time-of-day without date</td></tr>
        <tr><td><code>YEAR</code></td><td>1901 to 2155</td><td>Year-only values</td></tr>
    </table>
