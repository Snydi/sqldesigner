...
return [
    ...
    'receipt' => [
        ...
        'item_name' => env('ROBOKASSA_RECEIPT_ITEM_NAME') ?: 'SQL Designer Pro - monthly subscription',
        'payment_method' => env('ROBOKASSA_RECEIPT_PAYMENT_METHOD') ?: 'full_payment',
        'payment_object' => env('ROBOKASSA_RECEIPT_PAYMENT_OBJECT') ?: 'service',
